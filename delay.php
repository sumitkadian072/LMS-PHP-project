  ...
  <div class="container members mt-5">
    <div class="row">
      ...
      <div class="col-sm-4 p-5 pt-3 pb-2 pl-0 sidebar bg-light text-dark">
        ...
        <hr class="mt-1" />
        <ul>
          <li style="margin-top:-8px;">If items are reserved and not returned, Rs.1 a day to a maximum of Rs.50 per book</li>
          ...
          <li style="margin-top:-15px">Borrowers with fines that are over Rs.10 will have their cards temporarily blocked and will be unable to borrow items until the fine is paid.</li>
          <li>Borrowers who wish to dispute fines on their account should contact elibrary.edu with evidence of any mitigating circumstances.</li>
        </ul>
      </div>
