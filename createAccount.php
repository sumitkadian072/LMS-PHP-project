...
<body>
 ...
 <div class="container">
  <div class="form pt-3 pb-5 pl-2 pe-4">
   <h5 class="py-2 my-3 mx-2">Sign Up Form</h5>
   ...
   <form id="formData" method="post" action="./backend/createAccount.php" enctype="multipart/form-data" name="form">
    ...
    <div class="first_row">
     ...
     <input type="number" id="contact" class="outline-none" name="contact" placeholder="+91" onkeyup="validateContact()" style="outline:none" required />
    </div>
    <!-- email input -->
    ...
    <center>
     <a href="http://localhost/elibrary/login.php" id="redirect_link">Already have account ?</a>
    </center>
   </form>
  </div>
 </div>
